<template>
  <div id="detailContainer" class="slide-enter-active">
    <Header title="影片详情">
      <i class="iconfont icon-right" @touchstart="handleToBack">回</i>
    </Header>
...
.detail_list .detail_list_bg{width:100%; height:100%; background:url() 0 40%; filter:blur(20px);}
...
.detail_list .detail_list_info p{color:white; line-height:20px; font-size:14px}
